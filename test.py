...
# #client = OpenAI(api_key=os.environ.get("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"))
...
# audio = elevenlabs.generate(
#     text = "Hi, My name is harre and I've been outta my prime for the last 4 years",
#     voice = "Adam"
# )
